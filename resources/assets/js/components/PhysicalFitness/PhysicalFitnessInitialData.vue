<template>
    <div class="initial-data-wrapper">
        <h4 class="mb-3">Физическая подготовленность</h4>
                    ...
                    <div class="form-row d-flex align-items-end">
                        <div class="col-md-4 col-xs-12">
                            <div class="form-group" :class="{ 'has-error': form.errors.has('long_jump') }">
                                ...
                                <input type="text" class="form-control" id="long_jump" name="long_jump"
                        ...
                        <div class="col-md-4 col-xs-12 mb-3">
                          <div class="form-group" :class="{ 'has-error': form.errors.has('torso_inclination') }">
                            <label for="torso_inclination">Наклон туловища вперед</label>
                            <input type="text" class="form-control" id="torso_inclination" name="torso_inclination"
                        ...
                        <div class="col-md-4 col-xs-12 mb-3">
                          <div class="form-group" :class="{ 'has-error': form.errors.has('run_shuttle') }">
                            ...
                            <input type="text" class="form-control" id="run_shuttle" name="run_shuttle"
                        ...
                        <div class="col-md-4 col-xs-12 mb-3" v-if="user.profile.gender === 'man'">
                          <div class="form-group" :class="{ 'has-error': form.errors.has('pull_up') }">
                            ...
                            <input type="text" class="form-control" id="pull_up" name="pull_up"
                        ...
                        <div class="col-md-4 col-xs-12 mb-3">
                          <div class="form-group" :class="{ 'has-error': form.errors.has('push_up') }">
                            ...
                            <input type="text" class="form-control" id="push_up" name="push_up"
                        ...
                        <div class="col-md-4 col-xs-12 mb-3">
                          <div class="form-group" :class="{ 'has-error': form.errors.has('run_short') }">
                            ...
                            <input type="text" class="form-control" id="run_short" name="run_short"
                        ...
                        <div class="col-md-4 col-xs-12 mb-3">
                          <div class="form-group" :class="{ 'has-error': form.errors.has('run_long') }">
                            ...
                            <input type="text" class="form-control" id="run_long" name="run_long"
                            ...
                            <div class="form-row">
                                <div class="col-md-6 col-xs-12">
                                  <div class="form-group" :class="{ 'has-error': form.errors.has('swimming_s') }">
                                    <input type="text" class="form-control" id="swimming_s" name="swimming_s"
                                ...
                                <div class="col-md-6 col-xs-12">
                                  <div class="form-group" :class="{ 'has-error': form.errors.has('swimming_m') }">
                                    <input type="text" class="form-control" id="swimming_m" name="swimming_m"
        ...
        methods: {
          async getInitialData (semester) {
              ...
              try {
                  ...
                  const { data } = await axios.get(`/api/physical-fitness/initial-data/${semester}`)
          ...
          async updateInitialData () {
              try {
                  await this.form.patch(`/api/physical-fitness/calculation/${this.activeSemester}`)
