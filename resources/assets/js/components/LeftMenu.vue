      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <router-link tag="li" title="Главная" :to="{ name: 'welcome' }">
                <a><i class="fa fa-home"></i> <span>Главная</span></a>
            </router-link>
            <template v-if="check && user.role === 'teacher'">
                <li class="header">TEACHER</li>
                <router-link tag="li" title="Cтуденты" :to="{ name: 'teacher.students' }" active-class="active">
                    <a><i class="fa fa-users"></i> <span>Cтуденты</span></a>
                </router-link>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <router-link tag="li" :to="{ name: 'admin.staffs' }" active-class="active">
                    <a><i class="fa fa-circle-o"></i>Сотрудники</a>
                  </router-link>
                  <router-link tag="li" :to="{ name: 'admin.students' }" active-class="active">
                    <a><i class="fa fa-circle-o"></i>Студенты</a>
                  </router-link>
                </ul>
              </li>
              <li class="treeview">
                <a href="#"><i class="fa fa-database"></i> <span>Данные</span>
                	<span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
									</span>
                </a>
                <ul class="treeview-menu">
                    <router-link tag="li" :to="{ name: 'admin.faculties' }" active-class="active">
                        <a><i class="fa fa-circle-o"></i>Факультеты</a>
                    </router-link>
                    <router-link tag="li" :to="{ name: 'admin.health-groups' }" active-class="active">
                        <a><i class="fa fa-circle-o"></i>Мед. группы здоровья</a>
                    </router-link>
                    <router-link tag="li" :to="{ name: 'admin.disease-groups' }" active-class="active">
                        <a><i class="fa fa-circle-o"></i>Группы заболевания</a>
                    </router-link>
                </ul>
              </li>
              <router-link tag="li" title="Документы" :to="{ name: 'files' }" active-class="active">
                <a><i class="fa fa-files-o"></i> <span>Документы</span></a>
              </router-link>
            </template>
            <li class="header">Общее</li>
            <!-- Optionally, you can add icons to the links -->
            <router-link tag="li" title="Панель управления" :to="{ name: 'dashboard' }" active-class="active">
                <a><i class="fa fa-dashboard"></i> <span>Панель управления</span></a>
            </router-link>
						<!-- <li class="treeview">
            ...
            <router-link tag="li" title="Профайл" :to="{ name: 'profile' }" active-class="active">
                <a><i class="fa fa-user"></i> <span>Профайл</span></a>
            </router-link>
            <router-link v-if="user && user.role === 'student'" tag="li" title="Измерения и Показатели" :to="{ name: 'indicators' }" active-class="active">
                <a><i class="fa fa-database"></i> <span>Измерения и Показатели</span></a>
            </router-link>
            <router-link v-if="user && user.role === 'student'" tag="li" title="Статистическая обработка" :to="{ name: 'statistics.primary' }" active-class="active">
                <a><i class="fa fa-area-chart"></i> <span>Статистическая обработка</span></a>
            </router-link>
            <!-- <li><a><i class="fa fa-cog"></i> <span>Настройки</span></a></li> -->
            <li><a href="#" data-toggle="modal" data-target="#logout"><i class="fa fa-sign-out"></i> <span>Выйти</span></a></li>
        </ul>
        <!-- /.sidebar-menu -->
      </section>
      <!-- /.sidebar -->
