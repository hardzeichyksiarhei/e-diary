        ...
        <div class="form-row">
            <div class="col-md-2 col-xs-12 ">
                <div class="form-group" :class="{ 'has-error': form.errors.has('birthday') }">
                    <label for="birthday">Дата рождения <b class="text-danger">*</b></label>
            ...
            <div class="col-md-2 col-xs-12 ">
							<div class="form-group" :class="{ 'has-error': form.errors.has('gender') }">
								<label for="gender">Пол <b class="text-danger">*</b></label>
                <select class="form-control" id="gender" name="gender"
									:class="{ 'is-invalid': form.errors.has('gender') }"
									v-model="form.gender"
                >
									<option value="null">Выбрать...</option>
									<option v-for="gender in listGender" :value="gender.value" :key="gender.id">{{ gender.text }}</option>
                </select>
            ...
            <div class="col-md-4 col-xs-12 ">
							<div class="form-group" :class="{ 'has-error': form.errors.has('faculty_id') }">
 								<label for="faculty_id">Факультет <b class="text-danger">*</b></label>
            ...
            <div class="col-md-4 col-xs-12">
							<div class="form-group" :class="{ 'has-error': form.errors.has('teacher_id') }">
								<label for="teacher_id">Преподаватель <b class="text-danger">*</b></label>
        ...
        <div class="form-row">
            <div class="col-md-2 col-xs-12 ">
              <div class="form-group" :class="{ 'has-error': form.errors.has('course') }">
								<label for="course">Курс <b class="text-danger">*</b></label>
            ...
            <div class="col-md-2 col-xs-12 ">
              <div class="form-group" :class="{ 'has-error': form.errors.has('group') }">
								<label for="group">Группа <b class="text-danger">*</b></label>
            ...
            <div class="col-md-8 col-xs-12 ">
							<div class="form-group" :class="{ 'has-error': form.errors.has('health_group_id') }">
								<label for="medicalHealthTeam">Медицинская группа здоровья <b class="text-danger">*</b></label>
								<select class="form-control" id="health_group_id" name="health_group_id"
									:class="{ 'is-invalid': form.errors.has('health_group_id') }"
									v-model="form.health_group_id"
								>
									<option value="null">Выбрать...</option>
									<option v-for="medicalHealthTeam in listHealthGroups" :value="medicalHealthTeam.id" :key="medicalHealthTeam.id">
										{{ medicalHealthTeam.name }}
									</option>
								</select>
								...
								<tr v-for="groupDiseases in listDiseaseGroups" :key="groupDiseases.id">
									<td>
										<div class="custom-control custom-checkbox">
											<input type="checkbox" class="custom-control-input" :id="groupDiseases.id"
    ...
    export default {
        ...
        methods: {
            async fetchInitialData () {
                try {
                    let [ listTeachers, listFaculties, listDiseaseGroups, listHealthGroups ] = await Promise.all([
