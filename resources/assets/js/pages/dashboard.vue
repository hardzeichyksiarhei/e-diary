        ...
        <div class="row flex-row">
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="small-box bg-teal">
                    <div class="small-box-body">
                        <div class="inner">
                            <h3><i class="fa fa-user"></i>Профайл</h3>
            ...
            <!-- <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12"> -->
                ...
                <!-- <div class="small-box bg-maroon">
                    <div class="small-box-body">
                        <div class="inner">
                            <h3><i class="fa fa-envelope"></i>Сообщения</h3>

                            <p>Непрочитанных ({{ totalNotifications }})</p>
                        </div> -->
                        <!-- <div class="icon">
                            <i class="fa fa-cog"></i>
                        </div> -->
                    <!-- </div>
                    <router-link class="small-box-footer text-uppercase" :to="{ name: 'messages.inbox' }">
                        Перейти <i class="fa fa-arrow-circle-right"></i>
                    </router-link>
                </div>
            </div> -->
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="small-box bg-red">
                    <div class="small-box-body">
                        <div class="inner">
                            <h3><i class="fa fa-sign-out"></i>Выход</h3>
                    ...
                    <a href="#" class="small-box-footer text-uppercase" data-toggle="modal" data-target="#logout">
                        Выйти <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            <!-- ./col -->
            ...
            <div class="row flex-row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="small-box bg-green">
                        <div class="small-box-body">
                            <div class="inner">
                                <h3><i class="fa fa-users"></i>Студенты</h3>
            ...
            <div class="row flex-row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="small-box bg-green">
                        <div class="small-box-body">
                            <div class="inner">
                                <h3><i class="fa fa-database"></i>Измерения и Показатели</h3>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="small-box bg-purple">
                        <div class="small-box-body">
                            <div class="inner">
                                <h3><i class="fa fa-area-chart"></i>Статистическая обработка</h3>
                        ...
                        <router-link class="small-box-footer text-uppercase" :to="{ name: 'statistics.primary' }">
                            Перейти <i class="fa fa-arrow-circle-right"></i>
                        </router-link>
                    </div>
                </div>
            ...
            <div class="row flex-row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="small-box bg-green">
                        <div class="small-box-body">
                            <div class="inner">
                                <h3><i class="fa fa-users"></i>Cтуденты</h3>
  ...
  created () {
    if (!this.user.has_profile) {
      IziToast.info({
        ...
        overlay: true,
        message: '<p style="margin: 10px 0;">Перед тем как приступить к работе, заполните персональные данные.</p>',
        position: 'center',
        progressBarColor: '#fff',
        zindex: 9999,
        buttons: [
          ['<button>Перейти</button>', (instance, toast) => {
