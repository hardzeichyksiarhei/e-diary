      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom-pills">
          <ul class="nav nav-pills">
            <li class="active">
              <a href="#tables" data-toggle="tab">ФР и ФС (таблица)</a>
            </li>
            <li>
              <a href="#charts" data-toggle="tab">ФР и ФС (графики)</a>
            </li>
          </ul>
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right d-flex">
                    <a
                      ...
                      :href="`/api/export/excel/function-state/calculation/${user.id}`"
                    >
                ...
                <div class="box-body">
                  <div class="table-responsive">
                    <table
                      class="table table-no-hover table-bordered table-striped datatable"
                      style="width:100%"
                    >
                      <thead>
                        <tr>
  ...
  methods: {
    async fetchFunctionalState() {
      const { data } = await axios.get(
        "/api/functional-state/calculation/" + this.user.id
      );
