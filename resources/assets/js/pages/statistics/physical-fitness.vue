			...
			<div class="col-md-12">
				<div class="nav-tabs-custom-pills">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tables" data-toggle="tab">ФП (таблица)</a></li>
            <li><a href="#charts" data-toggle="tab">ФП (графики)</a></li>
					</ul>
					<div class="tab-content">
						<div class="active tab-pane" id="tables">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h4 class="box-title"><i class="fa fa-fw fa-table"></i>Показатели ФП (таблица)</h4>
									<div class="box-tools pull-right d-flex">
                    <a class="btn btn-box-tool text-light-blue" :href="`/api/export/excel/physical-fitness/calculation/${user}`">
...
export default {
  ...
  methods: {
    async fetchPhysicalFitness () {
      const { data } = await axios.get('/api/physical-fitness/calculation/' + this.user.id)
