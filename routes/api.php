...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::delete('functional-state/calculation/{userId}/{semester}', 'FunctionalStateController@destroyСalculationByUserIdAndSemester');
    ...
    Route::delete('physical-fitness/calculation/{userId}/{semester}', 'PhysicalFitnessController@destroyСalculationByUserIdAndSemester');
