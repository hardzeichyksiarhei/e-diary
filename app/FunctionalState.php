...
class FunctionalState extends Model
{
	 ...
	 */
	public function getCalculate($userId, $with_common_assessment = false)
	{
		...
		if ($with_common_assessment) {
			$labels["common_sum_scores"] = "Общая сумма баллов ФР, ФС и ФП";
			$labels["common_assessment"] = "Оценка физического состояния (ФР, ФС, ФП)";
			$labels["common_level"] = "Уровень физического состояния (ФР, ФС, ФП)";
		}

		$labels["updated_at"] = "Обновлено";
